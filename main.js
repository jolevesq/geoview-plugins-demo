...
var ThemeContext = node_modules_react.createContext(null);
...
function useTheme() {
  var theme = node_modules_react.useContext(useTheme_ThemeContext);
...
var StylesContext = node_modules_react.createContext(defaultOptions);
...
function useSynchronousEffect(func, values) {
  var key = node_modules_react.useRef([]);
  var output; // Store "generation" key. Just returns a new object every time

  var currentKey = node_modules_react.useMemo(function () {
    return {};
...
function makeStyles(stylesOrCreator) {
  ...
  var useStyles = function useStyles() {
    ...
    var stylesOptions = extends_extends({}, node_modules_react.useContext(StylesContext), stylesOptions2);

    var instance = node_modules_react.useRef();
    var shouldUpdate = node_modules_react.useRef();
...
const translation_namespaceObject = JSON.parse('{"custom":{"mapPosition":"Map Position"}}');
;// CONCATENATED MODULE: ./public/locales/fr-CA/translation.json
const fr_CA_translation_namespaceObject = JSON.parse('{"custom":{"mapPosition":"Localisation sur la carte"}}');
...
const MapPosition = () => {
  ...
  const w = window; // get a reference to the geoview api

  const cgpv = w['cgpv']; // import exported modules from the viewer
  ...
  const {
    ...
    useEffect,
    useRef
  } = react; // import another hook used by material ui, again if you import it directly it won't work

  const {
    makeStyles
  } = ui; // state used to store latitude and longtitude after map drag end
  ...
  const mapInstance = api.map('mapWM'); // add custom languages

  mapInstance.i18nInstance.addResourceBundle('en-CA', 'translation', translation_namespaceObject, true, false);
  mapInstance.i18nInstance.addResourceBundle('fr-CA', 'translation', fr_CA_translation_namespaceObject, true, false);
  useEffect(() => {
    ...
    DomEvent.disableScrollPropagation(positionContainerHTMLElement); // listen to map drag move end event
    ...
    api.on(api.eventNames.EVENT_MAP_MOVE_END, function (res) {
      ...
      if (res.handlerName === 'mapWM') {
        ...
        const position = res.position; // update the state
  ...
  }, /*#__PURE__*/node_modules_react.createElement("p", null, /*#__PURE__*/node_modules_react.createElement("strong", null, t('custom.mapPosition'), " from External Package:")), /*#__PURE__*/node_modules_react.createElement("p", null, "Latitude: ", lat), /*#__PURE__*/node_modules_react.createElement("p", null, "Longitude: ", lng));
};
...
const w = window; // get reference to geoview apis
...
const App = () => {
  ...
  (0,node_modules_react.useEffect)(() => {
    cgpv.init(() => {
       ...
       */
      cgpv.api.map('mapWM').addComponent('text', /*#__PURE__*/node_modules_react.createElement(MapPosition, null));
    });
  }, []);
  return /*#__PURE__*/node_modules_react.createElement("div", {
...
(0,react_dom.render)( /*#__PURE__*/node_modules_react.createElement(components_App, null), container);
