...
import { FooterbarEventKey } from './constants/footerbar';
...
import { FooterTabsEventKey } from './constants/footer-tabs';
 ...
 * Event categories
 */
export declare type EventCategories = 'MAP' | 'LAYER' | 'APPBAR' | 'FOOTERBAR' | 'NAVBAR' | 'SNACKBAR' | 'BASEMAP' | 'OVERVIEW_MAP' | 'DETAILS_PANEL' | 'MARKER_ICON' | 'DRAWER' | 'MODAL' | 'PANEL' | 'SLIDER' | 'VECTOR' | 'ATTRIBUTION' | 'FOOTER_TABS';
/**
 * Event keys
 */
export declare type EventKey = MapEventKey | LayerEventKey | AppbarEventKey | FooterbarEventKey | NavbarEventKey | SnackbarEventKey | BasmapEventKey | OverviewEventKey | DetailPanelEventKey | MarkerIconEventKey | DrawerEventKey | ModalEventKey | PanelEventKey | SliderEventKey | VectorEventKey | AttributionEventKey | FooterTabsEventKey;
/**
 * Event names
 */
export declare type EventStringId = 'map/loaded' | 'map/reload' | 'map/moveend' | 'map/zoomend' | 'map/add_component' | 'map/remove_component' | 'map/inkeyfocus' | 'map/crosshair_enable_disable' | 'map/view_projection_change' | 'map/fix_north' | 'layer/add' | 'layer/added' | 'layer/remove' | 'layer/get_layers' | 'appbar/panel_create' | 'appbar/panel_remove' | 'footerbar/expand_collapse' | 'navbar/button_panel_create' | 'navbar/button_panel_remove' | 'navbar/toggle_controls' | 'snackbar/open' | 'basemap/layers_update' | 'overview_map/toggle' | 'details_panel/crosshair_enter' | 'marker_icon/show' | 'marker_icon/hide' | 'drawer/open_close' | 'modal/create' | 'modal/open' | 'modal/close' | 'modal/update' | 'panel/open' | 'panel/close' | 'panel/add_action' | 'panel/remove_action' | 'panel/change_content' | 'slider/on_change_value' | 'slider/set_values' | 'slider/set_min_max' | 'vector/add' | 'vector/remove' | 'vector/added' | 'vector/off' | 'vector/on' | 'attribution/update' | 'footer_tabs/tab_create' | 'footer_tabs/tab_remove';
/**
