...
import { TypeFeatureStyle, TypeFeatureCircleStyle, TypeOfVector } from '../../../core/types/cgpv-types';
/**
...
export declare class VectorConfigPayload extends PayloadBaseClass {
     ...
     */
    static forCircle: (event: EventStringId, handlerName: string | null, coordinate: Coordinate, radius?: number | undefined, options?: {
        geometryLayout?: "XY" | "XYZ" | "XYM" | "XYZM" | undefined;
        style?: TypeFeatureCircleStyle | undefined;
    } | undefined, id?: string | undefined) => CircleConfigPayload;
    /**
     ...
     */
    static forCircleMarker: (event: EventStringId, handlerName: string | null, coordinate: Coordinate, radius?: number | undefined, options?: {
        geometryLayout?: "XY" | "XYZ" | "XYM" | "XYZM" | undefined;
        style?: TypeFeatureCircleStyle | undefined;
    } | undefined, id?: string | undefined) => CircleMarkerConfigPayload;
    /**
    ...
    static forMarker: (event: EventStringId, handlerName: string | null, coordinate: Coordinate, options?: {
        geometryLayout?: "XY" | "XYZ" | "XYM" | "XYZM" | undefined;
        style?: TypeFeatureStyle | undefined;
    } | undefined, id?: string | undefined) => MarkerConfigPayload;
    /**
    ...
    static forPolygon: (event: EventStringId, handlerName: string | null, points: Coordinate, options: {
        geometryLayout?: 'XY' | 'XYZ' | 'XYM' | 'XYZM';
        style?: TypeFeatureStyle;
    }, id?: string | undefined) => PolygonConfigPayload;
    /**
    ...
    static forPolyline: (event: EventStringId, handlerName: string | null, points: Coordinate, options: {
        geometryLayout?: 'XY' | 'XYZ' | 'XYM' | 'XYZM';
        style?: TypeFeatureStyle;
    }, id?: string | undefined) => PolylineConfigPayload;
}
/**
