...
export declare class API {
    ...
    eventNames: {
        ...
        FOOTERBAR: Record<"EVENT_FOOTERBAR_EXPAND_COLLAPSE", import("./events/event").EventStringId>;
        ...
        FOOTER_TABS: Record<import("./events/constants/footer-tabs").FooterTabsEventKey, import("./events/event").EventStringId>;
    };
