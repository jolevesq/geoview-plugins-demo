...
import { TypeBasemapProps, TypeBasemapLayer, TypeBasemapOptions, TypeJsonObject } from '../../../core/types/cgpv-types';
/**
...
export declare class Basemap {
     ...
     */
    createCoreBasemap: (basemapOptions: TypeBasemapOptions, projection?: number | undefined) => Promise<TypeBasemapProps | undefined>;
    /**
