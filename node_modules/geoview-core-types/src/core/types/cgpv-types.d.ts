 ...
 */
export declare type TypeMapView = {
    zoom: number;
    minZoom: number;
    maxZoom: number;
 ...
 */
export declare type TypeFeatureCircleStyle = {
    strokeColor?: string;
    strokeWidth?: number;
...
export declare type TypeNavBarProps = 'zoom' | 'fullscreen' | 'fullextent';
export declare type TypeNorthArrowProps = TypeJsonObject;
export declare type TypeMapComponents = 'appbar' | 'navbar' | 'north-arrow' | 'overview-map';
export declare type TypeMapCorePackages = 'basemap-panel' | 'layers-panel' | 'details-panel' | 'geolocator-panel';
...
export declare type TypeBasemapLayerSource = OSM | XYZ;
/**
